                                    ...
                                    <div class="row"> 
                                        <div class="col-md-5"> 
                                            <div class="form-group"> 
                                                <label for="field-1" class="control-label">Edit Service Group</label> 
							...
							<div class="col-sm-12">
								<div class="card-box">                                        
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-6"> 
                                            <div class="form-group"> 
                                                <label for="field-1" class="control-label">Delete Service Group</label> 
                                                <input type="text" name="prodName" class="form-control" id="field-1" placeholder="" required parsley-trigger="change">
                                            </div> 
                                        </div> 
                                        <div class="col-md-6"> 
							...
							<div class="col-sm-12">
								<div class="card-box">                                        
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-5"> 
                                            <div class="form-group"> 
                                                <label for="field-1" class="control-label">Add Service Group</label> 
                                                <input type="text" name="prodName" class="form-control" id="field-1" placeholder="" required parsley-trigger="change">
                                            </div> 
                                        </div> 
                                        <div class="col-md-5"> 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <table id="datatable-responsive"
                                ...
                                <tr>
                                <td>
                                    <a href="formservice_create.php?group=">
